...
public enum MediaCode implements ResultCode {
    ...
    UPLOAD_FILE_REGISTER_CREATEFOLDER_FAIL(false,22006,"上传文件在系统中注册创建文件夹失败！"),
    UPLOAD_FILE_UPLOAD_CREATEFOLDER_FAIL(false,22007,"上传文件在系统中创建分片文件夹失败！"),
    MERGE_FILE_CREATEFAIL(false,22008,"上传文件在合并文件时创建文件夹失败！"),
    MEIDA_FILE_NOT_EXISTS(false,22009,"媒体文件不存在");
