...
public class VideoUtil {
    ...
    String ffmpeg_path = "C:/Program Files/ffmpeg-20200831-4a11a6f-win64-static/bin/ffmpeg.exe";//ffmpeg的安装位置
    ...
    public static void main(String[] args) throws IOException {
        ...
        String video_time = videoUtil.get_video_time("D:/develop/ffmpeg/1.flv");
